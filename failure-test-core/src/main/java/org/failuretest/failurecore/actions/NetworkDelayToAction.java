...
public class NetworkDelayToAction extends Action {
    private static final Logger LOG = LoggerFactory.getLogger(NetworkDelayToAction.class);

    private String delayStr;
    private int timeInSec;
    private String[] ipList;

    public NetworkDelayToAction(String delayStr, Integer timeInSec, String[] ipList) {
        super(delayStr, timeInSec, ipList);
    ...
    public void perform() throws CommandExecutionException {
        ...
        CommandExecutionUtil.logCommandResult(this, getTarget().networkDelayTo(delayStr, timeInSec, ipList));
    }
}
