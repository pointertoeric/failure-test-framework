...
public class RecoverNetworkAction extends Action {
    private static final Logger LOG = LoggerFactory.getLogger(RecoverNetworkAction.class);

    public RecoverNetworkAction() {
        super();
        setNeedCleanUp(true);
    ...
    public void perform() throws CommandExecutionException {
        LOG.info("recover network on server {}...", getTarget());
        CommandExecutionUtil.logCommandResult(this,getTarget().recoverNetwork());
    }
}
